...
export class SolicitudContainerComponent implements OnInit {
  ...
  /**
   * Obtiene el nombre completo del cliente de una solicitud
   * @param solicitud La solicitud
   * @returns El nombre completo del cliente
   */
  getNombreCliente(solicitud: Solicitud): string {
    const cliente = solicitud.fichaTrabajo?.cliente;
    if (cliente) {
